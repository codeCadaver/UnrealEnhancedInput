...
#define DRAW_SPHERE_COLOR(Location, Size, Color) if (GetWorld()) \
	{ \
	DrawDebugSphere( GetWorld(), Location, 25.f, 24, Color, true); \
	};
...
#define DRAW_CROSSHAIRS( Location, Rotation ) if (GetWorld()) DrawDebugCrosshairs(GetWorld(), Location, Rotation, 155.f, FColor::Orange, true);/